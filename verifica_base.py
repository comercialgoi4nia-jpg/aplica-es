...
TIPOS_EXCLUIDOS_OPER = [
    ...
    "DENUNCIA FISCALIZACAO SEM UC/CLIENTE",
    "RD - EXECUÇÃO DE OBRA 120D",
    "RD - EXTENSÃO DE REDE MT - ATÉ 120 DIAS",
    "RD - DESLOCAMENTO DE POSTE",
    "AFERIÇÃO DE MEDIDOR",
    "ANÁLISE RETORNO AO AMBIENTE REGULADO",
    "BLOQUEIO POR COBRANÇA",
    "CADASTRAMENTO DE BAIXA RENDA",
    "CADASTRAMENTO DE BAIXA RENDA QUILOMBOLA",
    "CN - ANÁLISE DE VISTORIA",
    "CN - ORÇAMENTO ESTIMADO",
    "CONTRATO DE DEMANDA GD",
    "EXECUTAR TROCA DE TITULARIDADE / NEGOCIAÇÃO VOLUNTÁRIA ACIMA 1000",
    "DESLIGAMENTO DE UC - GRUPO A - UC VIRTUAL",
    ...
    "EXECUTAR TROCA DE TITULARIDADE COM DÉBITO ACIMA DE 1.000",
    ...
    "EXECUTAR TROCA DE TITULARIDADE / NEGOCIAÇÃO VOLUNTÁRIA ACIMA DE 1000 - GD",
    "TROCA DE TITULARIDADE SEM DÉBITO",
    "TROCA DE TITULARIDADE / NEGOCIAÇÃO VOLUNTÁRIA ACIMA 1000",
    "TROCA DE TITULARIDADE COM DÉBITO ACIMA DE 1.000",
    "TROCA DE TITULARIDADE COM DÉBITO",
    "RD - MELHORIA DE REDE",
    "TROCA DE TITULARIDADE GD - GRUPO B - COM DÉBITO ACIMA DE 1000"
